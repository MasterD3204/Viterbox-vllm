...
from src.chatterbox_vllm.models.t3.modules.learned_pos_emb import LearnedPositionEmbeddings
...
class T3VllmModel(nn.Module, VllmModelForTextGeneration, SupportsMultiModal):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str):
        ...
        if self.cfg.tokenizer == "EnTokenizer":
            text_tokens_dict_size = 704
        elif self.cfg.tokenizer == "ViTokenizer":
            text_tokens_dict_size = 2549 # Làm tròn lên từ 2548 cho an toàn, hoặc dùng chính xác 2549
        else:
            text_tokens_dict_size = 2454 # MtlTokenizer
        ...
        self.cfg_scale = float(os.environ.get("CHATTERBOX_CFG_SCALE", "0.7"))
